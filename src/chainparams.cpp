...
public:
    CMainParams() {
        ...
        // Deliverycoin: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("deliverycointools.com", "testnet-seed.deliverycointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.deliverycoin.loshan.co.uk"));
        ...
        // Deliverycoin: v2 enforced using Bitcoin's supermajority rule
