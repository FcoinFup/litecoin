# Support for Output Descriptors in Deliverycoin Core

Since Deliverycoin Core v0.17, there is support for Output Descriptors. This is a
...
on Deliverycoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Deliverycoin Core wallets, a convenience function `combo` is
