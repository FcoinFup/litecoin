...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Deliverycoin Core deliverycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  deliverycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded deliverycoin transaction") + "\n" +
              "  deliverycoin-tx [options] -create [commands]   " + _("Create hex-encoded deliverycoin transaction") + "\n" +
              "\n";
