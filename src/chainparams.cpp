...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const CScript genesisOutputScript = CScript() << ParseHex("0429e572075f77198976505517b80575521e376d779d58c47655bb1bd9ac55f1e58bfa077d735b114478ac93f696fe594ee7003f6a7f719ab934bb11f19ed532de") << OP_CHECKSIG;
...
public:
	...
	std::cout << consensus.hashGenesisBlock.ToString()<<std::endl;
        ...
        // vSeeds.emplace_back("seed-a.deliverycoin.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.deliverycointools.com");
        // vSeeds.emplace_back("dnsseed.deliverycoinpool.org");
...
public:
	...
	std::cout << consensus.hashGenesisBlock.ToString() << std::endl;
        ...
        vSeeds.emplace_back("testnet-seed.deliverycointools.com");
