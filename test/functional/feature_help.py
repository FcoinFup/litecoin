...
"""Verify that starting deliverycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start deliverycoin with -h for help text")
        ...
        self.log.info("Start deliverycoin with -version for version information")
        ...
        self.log.info("Start deliverycoind with -fakearg to make sure it does not start")
