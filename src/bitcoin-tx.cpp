...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " deliverycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  deliverycoin-tx [options] <hex-tx> [commands]  Update hex-encoded deliverycoin transaction\n" +
            "or:     deliverycoin-tx [options] -create [commands]   Create hex-encoded deliverycoin transaction\n" +
            "\n";
